...
For architectural decisions, read `docs/design/TOP_LEVEL_DIRECTIVES.md` first — it contains the 11 binding directives (D1–D11) that all design and code changes must satisfy.
...
| Architectural discussion or decision | `docs/design/TOP_LEVEL_DIRECTIVES.md` | Read D1–D11 first. Use the Decision Checklist before committing to a direction. |
