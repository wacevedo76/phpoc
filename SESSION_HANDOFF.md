...
## Current State
- **Branch:** `Flutter-features_and_ux` → pushed `4364ac2` (C-2 seed re-key web 4-phase TDD + settings genesis fix + web vitest baseline inventory)
...
- **🟠 Web↔Flutter parity queue (2026-08-28, ordered):** spec `docs/planning/WEB_FLUTTER_PARITY_SPEC.md`. **1) P4 ✅ DONE (2026-08-28)** `WEB_VITEST_HARNESS_PHASE1.md` → **2) P2** `C2_CROSS_CLIENT_VERIFY_PHASE1.md` (cross-client verify; Web↔Flutter legs now, CLI leg waits on CLI Phase A) → **3) P1** `COMMONPLACE_BOOK_WEB_ROADMAP.md` (Commonplace web port; slices 1–4 now, 5–6 when Flutter finishes them) → **4) P3** `WEB_STAGING_OPTION_A_PHASE1.md` (staging Option A refactor, last — no user-facing value). BACKLOG + MAP + planning AGENTS updated.
