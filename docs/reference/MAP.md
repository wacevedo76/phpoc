...
| `phpoc-web/src/components/layout/BookBody.jsx` | 🟢 GREEN | **NEW (Commonplace Slice 3, Phase 3)** — content-swap helper: renders `CommonplaceScreen` when book is `commonplace`, else the `ledgerScreen` node. |
